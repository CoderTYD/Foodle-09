...
-(void)viewDidLoad{
    ...
    UIButton *btn3 = [self buttonWithType:(UIButtonTypeCustom) image:[UIImage imageNamed:@"tabBar_new_icon"] selectedImage:[UIImage imageNamed:@"tabBar_new_click_icon"] title:@"圈子"];
